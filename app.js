...
let appName = chalk.magenta.underline.italic(` Welcome "${userName}" in Words Counter App: `);
...
async function wordCounter() {
    ...
    while (wordCounter) {
        ...
        const confirmation_ans = await inquirer.prompt({
            ...
            type: `confirm`,
            message: chalk.yellowBright(`You want to count the occurrences of your words again..? `),
            default: true,
        });
